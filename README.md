...
| --- | --- |
| Mac Apple Silicon | [Download DMG](https://github.com/Leo-hypno/saynext/releases/download/v0.2.0/SayNext-0.2.0-darwin-aarch64-dmg.dmg) |
| Mac Intel | [Download DMG](https://github.com/Leo-hypno/saynext/releases/download/v0.2.0/SayNext-0.2.0-darwin-x64-dmg.dmg) |
| Windows | [Download EXE](https://github.com/Leo-hypno/saynext/releases/download/v0.2.0/SayNext-0.2.0-windows-x64-nsis-setup.exe) |
